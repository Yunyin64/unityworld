...
- 新增 `BehaviorCardDefine`：行为卡定义，持有 StoryDefineId 列表或 Tags（动态匹配）
- 新增 `BehaviorCard` 实例与 `BehaviorCardMgr`：个体持有的行为卡运行时管理
- 新增 `BehaviorCardDataMgr`：行为卡静态定义加载器
...
- `action-card`：BehaviorCardDefine / BehaviorCard 实例 / BehaviorCardMgr 的完整行为卡系统
...
- **新增文件**：
  ...
  - `Scripts/Game/Data/Defines/BehaviorCardDefine.cs`
  - `Scripts/Game/Data/Mgr/StoryDefineMgr.cs`
  - `Scripts/Game/Data/Mgr/OptionDefineMgr.cs`
  - `Scripts/Game/Data/Mgr/BehaviorCardDataMgr.cs`
  ...
  - `Scripts/Game/Domain/BehaviorCard/BehaviorCard.cs`
  - `Scripts/Game/Domain/BehaviorCard/BehaviorCardMgr.cs`
- **修改文件**：
  - `Scripts/Game/Boot/WorldMgr.cs`：注册 StoryMgr、BehaviorCardMgr
  - `Scripts/Game/Data/GameDataMgr.cs`：注册 StoryDefineMgr、OptionDefineMgr、BehaviorCardDataMgr
