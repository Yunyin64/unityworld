...
- [x] 4.3 CombatCard.Contest() 构造 APIContext 并调用 Lua
- [x] 4.4 CombatCard.Apply() 构造 APIContext 并调用 Lua

## 5. 卡牌脚本补全

- [x] 5.1 更新 Data/LuaCards/card_form_quan_da.lua 的 Contest 填入 Attack(ctx, "Wu", "Da", 2)
